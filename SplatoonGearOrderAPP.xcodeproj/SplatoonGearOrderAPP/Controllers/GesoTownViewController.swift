...
//                    tableviewを更新するメソッド
            ...
            print("前回の利用記録がありません")
//            アラートのタイトルとメッセージの指定
            let alert: UIAlertController = UIAlertController(title: "アカウントが設定されていません", message: "この機能を利用するためにはログインが必要です\nアカウントを設定しますか？", preferredStyle: UIAlertController.Style.alert)
//            OKボタン
...
//                print(result)
    ...
    private func fetchGesoTownData(Iksm_session:String){
        let url: URL = URL(string: "https://app.splatoon2.nintendo.net/api/onlineshop/merchandises")!
