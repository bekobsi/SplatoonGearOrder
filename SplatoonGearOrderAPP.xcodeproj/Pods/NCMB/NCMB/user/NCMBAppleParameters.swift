...
public struct NCMBAppleParameters: NCMBSnsInfoProtocol {
    ...
    func toObject() -> [String: Any] {
        ...
        object[NCMBAppleParameters.PARAMETER_ID] = id
        object[NCMBAppleParameters.PARAMETER_ACCESS_TOKEN] = accessToken
        object[NCMBAppleParameters.PARAMETER_CLIENT_ID] = clientId
        return object
    }
}
