...
public struct NCMBFacebookParameters: NCMBSnsInfoProtocol {
    ...
    func toObject() -> [String: Any] {
        ...
        object[NCMBFacebookParameters.PARAMETER_ID] = id
        object[NCMBFacebookParameters.PARAMETER_ACCESS_TOKEN] = accessToken
        dateObject["__type"] = "Date"
        dateObject["iso"] =
            NCMBDateFormatter.getISO8601Timestamp(date: expirationDate)
