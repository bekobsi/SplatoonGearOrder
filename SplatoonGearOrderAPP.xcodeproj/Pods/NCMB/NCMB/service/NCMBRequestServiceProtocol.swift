...
extension NCMBRequestServiceProtocol {
    ...
    func fetch(object: NCMBBase, callback: @escaping (NCMBResult<NCMBResponse>) -> Void) {
        let request: NCMBRequest
        do {
    ...
    func save(object: NCMBBase, callback: @escaping (NCMBResult<NCMBResponse>) -> Void) {
        let request: NCMBRequest
        do {
    ...
    func delete(object: NCMBBase, callback: @escaping (NCMBResult<NCMBResponse>) -> Void) {
        let request: NCMBRequest
        do {
    ...
    func createGetRequest<T: NCMBBase>(query: NCMBQuery<T>) -> NCMBRequest {
        let object = NCMBBase(className: query.className)
        let request = NCMBRequest(
            apiType: apiType,
            method: NCMBHTTPMethod.get,
