...
public struct NCMBQuery<T: NCMBBase> {
    ...
    var query: [String: Any?] {
        ...
        if order.count > 0 {
            items[NCMBQueryConstants.REQUEST_PARAMETER_ORDER] = order.joined(separator: ",")
        }
        return items
    }
        ...
        if let collection = response.contents[NCMBQueryConstants.RESPONSE_PARAMTER_RESULTS] as? [Any] {
            ...
            for item in collection {
                if let item = item as? [String: Any] {
                    results.append(T(className: className, fields: item))
                }
            }
            return results
        }
    ...
    mutating func addOperation(field: String, operation: String, value: Any) {
        var item: [String: Any] = getFieldItem(field: field)
        item[operation] = convertToObject(value: value)
        whereItems[field] = item
    }
    ...
    public mutating func `where`(field: String, equalTo value: Any) {
        whereItems[field] = convertToObject(value: value)
    }
    ...
    public mutating func `where`(field: String, notEqualTo value: Any) {
        addOperation(field: field, operation: NCMBQueryConstants.OPERATOR_NE, value: value)
    }
    ...
    public mutating func `where`(field: String, lessThan value: Any) {
        addOperation(field: field, operation: NCMBQueryConstants.OPERATOR_LT, value: value)
    }
    ...
    public mutating func `where`(field: String, greaterThan value: Any) {
        addOperation(field: field, operation: NCMBQueryConstants.OPERATOR_GT, value: value)
    }
    ...
    public mutating func `where`(field: String, lessThanOrEqualTo value: Any) {
        addOperation(field: field, operation: NCMBQueryConstants.OPERATOR_LTE, value: value)
    }
    ...
    public mutating func `where`(field: String, greaterThanOrEqualTo value: Any) {
        addOperation(field: field, operation: NCMBQueryConstants.OPERATOR_GTE, value: value)
    }
    ...
    public mutating func `where`(field: String, containedIn value: [Any]) {
        addOperation(field: field, operation: NCMBQueryConstants.OPERATOR_IN, value: value)
    }
    ...
    public mutating func `where`(field: String, notContainedIn value: [Any]) {
        addOperation(field: field, operation: NCMBQueryConstants.OPERATOR_NIN, value: value)
    }
    ...
    public mutating func `where`(field: String, exists value: Any) {
        addOperation(field: field, operation: NCMBQueryConstants.OPERATOR_EXISTS, value: value)
    }
    ...
    public mutating func `where`(field: String, toMatchPattern value: String) {
        addOperation(field: field, operation: NCMBQueryConstants.OPERATOR_REGEX, value: value)
    }
    ...
    public mutating func `where`(field: String, containedInArrayTo value: [Any]) {
        addOperation(field: field, operation: NCMBQueryConstants.OPERATOR_INARRAY, value: value)
    }
    ...
    public mutating func `where`(field: String, notContainedInArrayTo value: [Any]) {
        addOperation(field: field, operation: NCMBQueryConstants.OPERATOR_NINARRAY, value: value)
    }
    ...
    public mutating func `where`(field: String, containsAllObjectsInArrayTo value: [Any]) {
        addOperation(field: field, operation: NCMBQueryConstants.OPERATOR_ALL, value: value)
    }
...
private enum NCMBQueryConstants {
