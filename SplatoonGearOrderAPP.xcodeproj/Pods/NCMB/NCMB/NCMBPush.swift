...
public class NCMBPush: NCMBBase {
    ...
    public var deliveryExpirationDate: Date? {
        ...
        set {
            ...
            if newValue != nil {
                removeField(field: NCMBPush.FIELDNAME_DELIVERYEXPIRATIONTIME)
            }
        }
    }
    ...
    public var deliveryExpirationTime: NCMBExpirationTime? {
        ...
        set {
            if let newValue = newValue {
                ...
                removeField(field: NCMBPush.FIELDNAME_DELIVERYEXPIRATIONDATE)
            } else {
                removeField(field: NCMBPush.FIELDNAME_DELIVERYEXPIRATIONTIME)
            }
        }
