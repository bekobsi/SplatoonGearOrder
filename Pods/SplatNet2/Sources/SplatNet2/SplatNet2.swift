...
public class SplatNet2 {
    ...
    public class func getSessionToken(_ session_token_code: String, _ session_token_code_verifier: String, _ UA: String = "Salmonia/0.1.5") throws -> JSON {
    ...
    public class func isValid(iksm_session: String) -> Bool {
        ...
        do {
            let _ = try SplatNet2.get(url, iksm_session: iksm_session)
            return true
        } catch {
           return false
        }
